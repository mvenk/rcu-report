...
\begin{figure}[tph]
\includegraphics[scale = 0.25]{../images/diagrams/radixtree2.eps}
...
\hline
A call to \verb$make_radix()$ is made. &  A call to \verb$make_radix()$ is made.\\
\hline
...
\textbf{Thread 1} & \textbf{Thread 2}\\
\hline
A call to \verb$reserve_and_pushback()$ is made. &  A call to \verb$reserve_and_pushback$ is made.\\
\hline
\begin{tabular}{p{1.5in}}
\\  
