...
consider any task in Epoch N-2,
The local epoch can either be 0 or 1.
If le==1,
The gloabl epoch can move to N-1 only after all lei have been reset to 0. lei is reset to zero only after the task finishes, 
since the task finishes before GE N-1, it finishes before GE N.

If le==0,
The GE =N-2, le will be set at the begining of GE=N-1.
le will be reset before GE moves to N.
le will be reset only after this task finishes.
\end{algorithmic}
