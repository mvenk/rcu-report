...
\begin{figure}[tph]
\fbox{
\includegraphics[scale = 0.4]{readers_comparison.png}
}
\caption{Performance comparison over a pure reader workload}
...
\begin{center}
\fbox{
\includegraphics[scale = 0.4]{rcu_comparison.png}
}
...
\begin{center}
\fbox{
\includegraphics[scale = 0.5]{writeintensive.png}
}
...
\begin{figure}[tph]
\includegraphics[scale = 0.8]{../images/diagrams/graphs/macro_reader_100k.eps}
...
\begin{figure}[tph]
\includegraphics[scale = 0.8]{../images/diagrams/graphs/macro_writer_100k.eps}
