...
\paragraph{Requirements for Userlevel Elements}
 We have provided a class called ReclaimHook displayed in Listing \ref{lst:reclaimhook}. A userlevel Element which seeks to use RCU synchronization using our API should follow the procedure outlined below:
\begin{enumerate}
...
Rohit Kumar contributed equally to this project. This work reflects his energy and inputs. Rohit worked in an organized manner, and has a knack for automation and elegance.
I've learned a lot from him.

I am thankful to my parents and sister for their unconditional loving support.
